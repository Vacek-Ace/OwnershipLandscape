...
def generate_and_execute_7_models_pipeline():
    # 1. Substantive models
    substantive_models = [
...
*(Nota: La categoría residual no resuelta `unknown` ha sido excluida de la operacionalización sustantiva del landscape, re-normalizando las proporciones sobre los 7 modelos fundamentales según las mejores prácticas en análisis de datos composicionales).*
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :--- |
| **Bundesliga** | $(+2.761, -0.899)$ | $(+2.761, -0.899)$ | $(+2.761, -0.899)$ | $(+2.761, -0.899)$ | $(+2.783, -0.994)$ | **$(+3.151, -0.628)$** | **Cuadrante III (Inferior Derecho)** |
| **LaLiga** | $(+0.740, +0.271)$ | $(+1.136, +0.368)$ | $(+0.409, -0.058)$ | $(+0.564, +0.047)$ | $(+0.762, +0.163)$ | **$(+0.487, +0.471)$** | **Cuadrante I (Superior Derecho)** |
| **Premier League**| $(+0.099, +2.213)$ | $(-0.297, +2.116)$ | $(-0.071, +2.242)$ | $(-0.361, +2.683)$ | $(-0.296, +2.450)$ | **$(-0.399, +3.062)$** | **Cuadrante II (Superior Izquierdo)** |
| **Serie A** | $(-1.906, -2.078)$ | $(-1.809, -1.570)$ | $(-1.874, -1.337)$ | $(-1.478, -1.240)$ | $(-1.478, -1.240)$ | **$(-1.711, -0.161)$** | **Cuadrante IV $\\to$ Ascenso vertical** |
| **Ligue 1** | $(-1.406, -1.420)$ | $(-1.406, -1.420)$ | $(-1.294, -0.853)$ | $(-1.264, -0.164)$ | $(-2.121, +0.223)$ | **$(-2.004, +0.450)$** | **Cuadrante IV $\\to$ Cuadrante II** |

*   **1. Bundesliga (El Anclaje Proteccionista del 50+1 en el Cuadrante III)**:
    Permanece aislada en el cuadrante inferior derecho ($PC1 > +2.7, PC2 < 0$), inmune a la financiarización anglosajona. Su desplazamiento hacia la derecha en 2024 ($PC1 = +3.15$) responde a la renuncia voluntaria de Dietmar Hopp a su estatus de excepción en el Hoffenheim, devolviendo la mayoría de votos al club asociativo y reforzando la hegemonía democrática del 50+1.
*   **2. Premier League (El Polo Supremo de la Multipropiedad en el Cuadrante II)**:
    Se ubica en la cúspide del Cuadrante II ($PC2 > +2.1$). Su vector se proyecta hacia la cima absoluta ($y = +3.06$ en 2024), reflejando la absorción continua de clubes en redes multi-club transnacionales (Chelsea a BlueCo, Bournemouth a Black Knight, Burnley a ALK Capital).
*   **3. LaLiga (El Equilibrio Híbrido en el Cuadrante I)**:
    Se mantiene en el **Cuadrante I** ($PC1 \\in [0.41, 1.14]$, $PC2 \\in [-0.06, 0.47]$). La existencia de sus 4 clubes de socios actúa como un contrapeso estructural hacia la derecha, mientras que sus estructuras híbridas y adquisiciones en red (Girona/CFG) la sitúan en la zona superior de integración internacional.
*   **4. Serie A y Ligue 1 (La Gran Reconfiguración Hacia Arriba)**:
    En 2019, ambas ligas se situaban en la base profunda del Cuadrante IV ($y = -2.08$ y $y = -1.42$), dominadas por familias empresariales locales de cartera individual. Entre 2019 y 2024, **ambas ligas describen una espectacular trayectoria ascendente vertical**. La Ligue 1 llega a cruzar al Cuadrante II ($y = +0.45$) y la Serie A asciende hasta el borde del eje neutro ($y = -0.16$), constatando empíricamente la colonización del sur de Europa por fondos norteamericanos y redes multipropiedad.""")
...
3. **Implicaciones de Política Regulatoria y Gobernanza de la UEFA**:
   La rápida expansión de las redes de multipropiedad (que ya alcanzan o superan el $25\\%$ en 4 de las 5 grandes ligas —todas salvo la Bundesliga— y llegan al $60\\%$ en Inglaterra) plantea desafíos regulatorios inmediatos sobre la integridad competitiva, los traspasos intra-grupo y la multipropiedad en competiciones UEFA, exigiendo un marco de supervisión adaptado a la realidad de las redes corporativas transnacionales.""")
    ...
    print(f"Successfully generated {out_path} with 7 substantive models and {len(nb['cells'])} cells.")

if __name__ == "__main__":
    generate_and_execute_7_models_pipeline()
